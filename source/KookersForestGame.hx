...
class KookersForestGame extends MusicBeatState
{
    ...
    override function update(elapsed:Float)
    {
        ...
        if (dead)
        {
            if (FlxG.keys.justPressed.ENTER) FlxG.switchState(new KookersForestGame()); // PLEASE SHUT UP IM TIRED AND LAZY
            else if (FlxG.keys.justPressed.ESCAPE) FlxG.switchState(new MainMenuState());
        }
