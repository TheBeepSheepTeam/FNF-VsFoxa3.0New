...
class NoteSplash extends FlxSprite
{
	...
	public function setupNoteSplash(x:Float, y:Float, note:Int = 0, texture:String = null, color:FlxColor = FlxColor.WHITE, hueColor:Float = 0,
			satColor:Float = 0, brtColor:Float = 0)
	{
		...
		if (texture == null)
		{
			...
			else if (ClientPrefs.arrowMode == 'RGB')
