...
class VisualsUISubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Note Coloring Method:', "Determines which method is used for changing note colors.", 'arrowMode', 'string', 'RGB',
			['RGB', 'HSV']);
		addOption(option);

		var option:Option = new Option('Icon Animation:', "What animation should the healthbar icons do?", 'iconSwing', 'string', 'Swing',
