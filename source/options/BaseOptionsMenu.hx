						...
						else if (curOption.type != 'string')
						{
							...
							switch (curOption.type)
							{
								...
								case 'float' | 'percent':
									...
									curOption.isModItem ? curOption.emulatedVal = FlxMath.roundDecimal(holdValue,
										curOption.decimals) : curOption.setValue(FlxMath.roundDecimal(holdValue, curOption.decimals));
							}
							updateTextFrom(curOption);
							curOption.change();
						}
